    ...
    return (
        <div className="md:p-10 py-6">
            ...
            <div className="flex flex-row gap-5 mt-10">
                ...
                <div className="shadow-xl rounded-3xl w-1/3 text-white p-10 flex flex-col relative overflow-hidden gap-4">
                    <img
                        src="../../public/WebStorm_1280x789.png"
                        alt="img"
                    ...
                    <h2 className="relative z-10 bg-opacity-50 p-2 rounded-md text-5xl">Oskar Kišš</h2>
                    <button className="relative z-10 btn-white text-white bg-black bg-opacity-50 p-2 rounded-md">
                        Volejte hned
                    </button>
